...
class HotplateOutScreen extends StatefulWidget {
  const HotplateOutScreen({super.key});

  @override
  State<HotplateOutScreen> createState() => _HotplateOutScreenState();
}

class _HotplateOutScreenState extends State<HotplateOutScreen> {
