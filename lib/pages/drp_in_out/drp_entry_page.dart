...
import 'package:smart_distributor_app/pages/drp_in_out/drp_in_screen.dart';
import 'package:smart_distributor_app/pages/drp_in_out/drp_out_screen.dart';

class DrpEntryScreen extends StatefulWidget {
  const DrpEntryScreen({super.key});

  @override
  State<DrpEntryScreen> createState() => _DrpEntryScreenState();
}

class _DrpEntryScreenState extends State<DrpEntryScreen> {
  final DrpController controller = Get.put(DrpController());
