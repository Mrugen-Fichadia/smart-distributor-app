...
import 'package:smart_distributor_app/common/utils/colors.dart'; // Assuming these colors are defined
...
class RecentDeliveriesPage extends StatelessWidget {
  RecentDeliveriesPage({super.key});
