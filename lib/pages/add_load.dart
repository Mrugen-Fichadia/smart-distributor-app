...
class _AddLoadScreenState extends State<AddLoadScreen> {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(Icons.propane_tank, color: primary),
              const SizedBox(width: 8),
              const Text(
                'Cylinder Type',
                style: TextStyle(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(Icons.inventory, color: primary),
              const SizedBox(width: 8),
              const Text(
                'Quantity Details',
                style: TextStyle(
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    'No defective cylinders added',
                    style: TextStyle(color: Colors.grey[600], fontSize: 14),
                  ),
                  const SizedBox(height: 4),
                  Text(
                    'Tap + to add defective cylinder records',
  ...
  void _showAddDefectiveDialog() {
    ...
    Get.dialog(
      AlertDialog(
        title: const Text('Add Defective Cylinder'),
    ...
    if (_formKey.currentState!.validate()) {
      Get.dialog(
        AlertDialog(
          ...
          content: const Text(
            'Are you sure you want to submit this load record?',
          ),
          actions: [
            TextButton(
              onPressed: () => Get.back(),
